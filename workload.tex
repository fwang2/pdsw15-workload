...
\item ReACT\textsuperscript{TM}
The Real-time Adaptive Cache Technology (ReACT\textsuperscript{TM}) feature was developed
...
We feel that this feature has allowed Spider 2 to reach the low latencies across the
spectrum of write request sizes and is a large benefit to our users. 
